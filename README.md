...
## 업데이트 내역
- 2026-07-17 [v0.1] **베타 버전 공개**: AI 번역 적용, 모든 폰트에 개별 폴백 폰트 적용, 어절 단위 줄바꿈 적용, 영어 이미지 적용
...
## 기타 안내 사항
- 본 패치는 개발사의 허가 하에 제작되었으며, 개발사/권리자의 요청이 있을 경우 언제든 내려갈 수 있습니다.
