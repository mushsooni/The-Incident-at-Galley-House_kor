...
### 다운로드
https://github.com/mushsooni/The-Incident-at-Galley-House_kor/releases/download/v0.4/Galley-House_KO_v0.4.zip  
(최근 업데이트: 26-07-21 09:30)
...
- 현재 이미지 에셋은 대부분 영어로 출력됩니다. 손번역 일정에 맞추어 한국어 이미지로 함께 교체될 예정입니다.
...
두 이슈는 패치와 무관한 고도 엔진의 IME(입력 방식 편집기) 자체의 버그로 추정됩니다. 다른 분께 제공받은 수정 코드를 적용하여 테스트 중입니다.

### 게임 원본 빌드
- **기준일**: 한국시간 2026-07-20 23:37:40
