...
### 다운로드
https://github.com/mushsooni/The-Incident-at-Galley-House_kor/releases/download/v0.3/Galley-House_KO_v0.3.zip
...
- 대규모 업데이트로 인해 위 방법으로도 한글패치가 불가능한 경우, 아래 **문의, 제보** 링크로 제보 바랍니다.  
  (게임 원본 빌드를 참고하여 [버전을 롤백](https://blog.naver.com/toruin84/222898486431)하면 임시로 플레이가 가능합니다.)
...
- **1, 2번** 이슈는 고도 엔진의 IME(입력 방식 편집기) 자체의 버그로 추정됩니다. 다른 분께 제공받은 수정 코드를 적용하여 플레이 테스트 중입니다.
...
- 2026-07-19 [v0.3] 게임 업데이트 대응(Build 24275135), [person] 및 %s 태그 뒤 한국어 조사 자동 변환
