...
2. **(선택)** `.exe` 파일을 게임 폴더에 놓고 실행  
   `Windows의 PC 보호` 창이 뜨는 경우 `추가 정보` - `실행`
...
- 현재 일부 AI 번역이 적용되어 번역의 질이 다소 미흡할 수 있습니다. v0.1 공개일 기준 약 두 달에 걸쳐 **손번역**으로 교체될 예정입니다.
- 이미지 에셋 중 일부는 영어로 출력됩니다. 게임 내 **오버레이 자막** 기능을 사용하시기 바랍니다.  
  손번역 일정에 맞추어 한국어 이미지로 교체 작업 중입니다.

## ★ 알려진 문제 ★
- 수첩 등에서 한글 입력 중에 입력창을 닫고 방향키를 누르면, **이동 입력이 유지**되는 버그가 있습니다.  
...
원작의 한국어 표현을 일부 참고하였습니다. 멋진 게임을 한국어로 소개해주셔서 감사합니다.
...
- 2026-08-12 [v0.7.3] IME 버그 추가 수정, 수동 보정 한글 입력 차단, 인자 노출 문제 수정, 장치 폰트 수정, 이미지 한글화, 기타 번역 검수
...
- [**DX타자**](https://www.dxkorea.co.kr/goods/goods_view.php?goodsNo=1000000037&pageNm=font) Medium ([License](https://www.dxkorea.co.kr/main/html.php?htmid=/service/freefont.html))

- [**가평한석봉**](https://www.gp.go.kr/portal/contents.do?key=2410) 큰붓B  
본 패치의 텍스처 에셋 중 일부는 가평한석봉 큰붓B를 사용하여 제작되었습니다.

- [**굵은둥근모**](https://github.com/sawalk/Korean-Font-Change/releases/tag/Bold-v0.2)

- [**그리운 옥수니 손글씨**](https://www.griun.co.kr/fonts/oksooni)

- [**에스코어 드림**](https://s-core.co.kr/company/font2/) 8 Heavy

- [**영월체**](https://www.yw.go.kr/www/contents.do?key=1500)

- [**인천교육힘찬체**](https://www.ice.go.kr/ice/cm/cntnts/cntntsView.do?mi=10874&cntntsId=943)

- [**조선궁서체**](https://event.chosun.com/100/100font.html)

- [**카페24 PRO Slim Fit**](https://fonts.cafe24.com/)
...
- [**KCC손기정체**](https://gongu.copyright.or.kr/gongu/wrt/wrt/view.do?wrtSn=13305046&menuNo=200023)

- [**KCC임권택체**](https://gongu.copyright.or.kr/gongu/wrt/wrt/view.do?wrtSn=13285735&menuNo=200023)

- [**LAB디지털**](https://fontlab.kr/notice/?uid=11&mod=document) ([License](https://fontlab.kr/notice/?uid=9&mod=document))

- [**Noto Sans Korean**](https://fonts.google.com/noto/specimen/Noto+Sans+KR) Bold
